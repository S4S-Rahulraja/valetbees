...
const  ActiveSlotComponent = ({ navigation }) => {
    ...
    <View style={styles.allhomecontainer}>  
           <StatusBar style="auto"></StatusBar>
                ...
                <View style={styles.allpatalign}>
                    <View>
                         <Text style={styles.Openfirsttxt1}>Active Token</Text>
                    </View>
              ...
              <View style={styles.footButton1}>
                      <TouchableOpacity style={styles.logbutton12} onPress={GoRequest}>
                           <Ionicons name="alarm" size={24} color="#FF9901"  style={styles.normalIcon}  />
              ...
              <View style={styles.footButton1}>
                      <TouchableOpacity style={styles.logbutton12} onPress={GoActiveSlot}>
                              <Ionicons name="checkmark-circle" size={24} color="#FF9901"  style={styles.colorIcon}  />
                              <Text style={styles.colortext}>Active Slot</Text>
                      </TouchableOpacity>
              </View>                
          </View>
        </View>
...
module.exports = ActiveSlotComponent;